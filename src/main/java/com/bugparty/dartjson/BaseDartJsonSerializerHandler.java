...
public abstract class BaseDartJsonSerializerHandler implements LanguageCodeInsightActionHandler {
    @Override
    ...
    protected final static Condition<DartComponent> NOT_CONSTRUCTOR_CONDITION =
            component -> DartComponentType.typeOf(component) != DartComponentType.CONSTRUCTOR;

    protected final static Condition<DartComponent> NOT_STATIC_CONDITION = component -> !component.isStatic();
