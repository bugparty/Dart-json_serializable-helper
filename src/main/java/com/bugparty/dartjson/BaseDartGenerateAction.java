...
public abstract class BaseDartGenerateAction extends AnAction {
    ...
    protected static Pair<Editor, PsiFile> getEditorAndPsiFile(final AnActionEvent e) {
        final Project project = e.getData(CommonDataKeys.PROJECT);
    ...
    @NotNull
    protected abstract BaseDartJsonSerializerHandler getGenerateHandler();
    ...
    public void update(@NotNull final AnActionEvent e) {
        ...
        PsiTreeUtil.collectElements(psiFile, (element -> PsiTreeUtil.getParentOfType(element, DartClass.class) != null));
